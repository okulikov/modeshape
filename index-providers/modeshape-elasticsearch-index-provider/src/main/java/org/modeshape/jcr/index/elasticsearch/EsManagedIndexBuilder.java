...
public class EsManagedIndexBuilder extends ManagedIndexBuilder {
     ...
     */
    public static EsManagedIndexBuilder create(Node node, Client client, ExecutionContext context,
        ...
        return new EsManagedIndexBuilder(node, client, context, defn, nodeTypesSupplier, workspaceName, matcher);
    }
    ...
    protected EsManagedIndexBuilder(Node node, Client client,
    ...
    protected ProvidedIndex<?> buildMultiValueIndex(ExecutionContext context, IndexDefinition defn, String workspaceName, NodeTypes.Supplier nodeTypesSupplier, ChangeSetAdapter.NodeTypePredicate matcher) {
        return new EsIndex(context, defn, workspaceName, node, client);
    }
