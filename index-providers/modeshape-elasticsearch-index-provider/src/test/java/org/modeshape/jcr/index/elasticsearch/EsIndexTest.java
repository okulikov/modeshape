...
public class EsIndexTest {
    ...
    public static void setUpClass() {
        ...
        index = new EsIndex(cols, context, "test", "workspace", esNode, client);
    ...
    public void shouldSupportComparisonConstraint() {
        ...
        validate(ne, "key1", "key3", "key4", "key5", "key6");        
    ...
    public void shouldNotTokenizeOnIntrawordDelimeter() {
        index.add(key("key6"), "myfield", "asd-sdf-dfg");
    ...
    public void shouldConvertValuesToCoreTypes() {
        ...
        index.add(key("key6"), "mixinTypes", new Object[]{n1});
